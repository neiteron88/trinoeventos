  ...
  const cards = [
    {
      ...
      details: 'El enfoque de J&A está en los detalles invisibles que hacen que los invitados se sientan abrazados por el evento. No es solo un casamiento o encuentro con pocos invitados; es un refugio temporal donde todos son protagonistas, con un ritmo orgánico y real.',
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-16 relative">
          <div className="w-full lg:w-1/3">
            <h2 className="text-4xl md:text-5xl font-heading text-white flex items-center">
              ELEGÍ TU VIBRA <span className="text-[#ccff00] text-2xl ml-2 font-sans">*</span>
            </h2>
          ...
          <div className="hidden lg:flex absolute left-1/3 -bottom-10 w-32 h-32 items-center justify-center pointer-events-none">
             <div className="absolute inset-0 border border-[#ccff00]/20 rounded-full animate-[spin_10s_linear_infinite] border-dashed"></div>
             ...
             <svg viewBox="0 0 100 100" className="absolute w-full h-full animate-[spin_20s_linear_infinite]">
                ...
                <text className="text-[10px] tracking-widest fill-[#ccff00] uppercase font-semibold">
            ...
            >
              ...
              <div className="absolute inset-0 z-20 flex flex-col items-center justify-center p-6 text-center">
                <motion.h3 
                  ...
                  className="font-script text-5xl md:text-6xl text-white mb-4 shadow-sm group-hover:text-[#ccff00] transition-colors duration-300"
                >
                  {card.title}
                </motion.h3>
                <motion.p 
              ...
              {cards.filter(c => c.id === selectedId).map(card => (
                ...
                >
                  ...
                  <button 
                    ...
                    className="absolute top-6 right-6 z-50 w-10 h-10 bg-black/50 backdrop-blur-md rounded-full flex items-center justify-center text-white hover:bg-[#ccff00] hover:text-black transition-colors border border-white/20"
                  >
                    <X size={20} />
                  </button>
                  ...
                  <div className="w-full md:w-1/2 h-64 md:h-full relative">
                    ...
                    <div className="absolute inset-0 z-20 flex flex-col justify-end md:justify-center p-8 md:p-16">
                      ...
                      <motion.p 
                        layoutId={`card-subtitle-${card.id}`}
                        className="text-xs md:text-sm font-bold tracking-[0.3em] text-[#ccff00] uppercase"
                      >
                        {card.subtitle}
                      </motion.p>
                    </div>
                  ...
                  <div className="w-full md:w-1/2 h-full overflow-y-auto p-8 md:p-16 flex flex-col">
                    <h4 className="text-[10px] font-bold tracking-widest text-white uppercase mb-6 flex items-center">
                      Nuestra Filosofía <span className="text-[#ccff00] ml-2 text-lg">*</span>
                    </h4>
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-8">
                        {card.highlights.map((highlight, idx) => (
                          <div key={idx} className="flex items-center space-x-3 text-gray-300">
                            <div className="text-[#ccff00]">{highlight.icon}</div>
                    ...
                    {card.id === 3 && (
                      <div className="mb-12">
                        <a 
                          href="/corporativo" 
                          className="inline-flex items-center px-6 py-3 border border-[#ccff00] text-[#ccff00] hover:bg-[#ccff00] hover:text-black transition-colors text-xs font-bold tracking-widest uppercase"
                        >
