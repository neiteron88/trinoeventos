...
const ManifestoAndTestimonials = () => {
  const testimonials = [
    {
      quote: "trino entendió perfectamente cómo alinear nuestro evento con los estándares globales de la MLS. Su nivel de profesionalismo, atención al detalle y ejecución es verdaderamente de primer nivel.",
        ...
        <div className="w-full lg:w-1/2 flex flex-col md:flex-row relative">
          ...
          <div className="w-full md:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center relative z-20 bg-black/80 md:bg-transparent -mt-20 md:mt-0">
            <h2 className="text-[10px] font-bold tracking-widest text-white uppercase flex items-center mb-6">
              NUESTRO MANIFIESTO <span className="text-[#00E56A] text-lg ml-2">*</span>
            </h2>
            ...
            <p className="text-sm md:text-base text-gray-300 font-light leading-relaxed mb-8 max-w-md">
              Con más de dos décadas de trayectoria en la industria de los eventos, he explorado cada ángulo de esta pasión. trino nace de esa experiencia acumulada, transformando la creatividad en nuestro motor y la precisión técnica en nuestra firma.
              <br /><br />
            ...
            <div className="mb-10">
              <p className="text-[#00E56A] font-script text-4xl md:text-5xl leading-none">Julián Lettieri</p>
            ...
            <a href="#historia" className="flex items-center text-xs font-semibold tracking-widest text-white group w-fit">
              ...
              <ArrowRight size={16} className="ml-4 text-[#00E56A] group-hover:translate-x-1 transition-all" />
            </a>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 bg-[#0a0a0a] p-8 md:p-16 lg:p-20 flex flex-col border-t lg:border-t-0 lg:border-l border-white/10 relative">
          ...
          <div className="flex items-center justify-between mb-16">
            <h2 className="text-[10px] font-bold tracking-widest text-white uppercase flex items-center">
              LO QUE DICEN <span className="text-[#00E56A] text-lg ml-2">*</span>
            </h2>
